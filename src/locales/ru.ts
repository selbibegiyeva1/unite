export const ru = {
  ...
  navbar: {
    ...
    reports: 'Выплаты',
    help: 'Помощь',
    creditDebt: 'Задолженность по кредиту',
  ...
  sidebar: {
    ...
    tokenLabel: 'Ваш токен',
      tokensManagement: 'Управление токенами',
    logout: 'Выйти',
    loggingOut: 'Выходим...',
  },
  homeOperator: {
  ...
  help: {
    ...
    contacts: {
      ...
      support: 'Поддержка: +993 (62) 42-31-18',
  ...
  homeDirector: {
    ...
    byTransactions: '(по транзакциям)',
    totalLabel: 'Всего',
    topClientsTitle: 'Топ-5 клиентов',
    topClientsEmail: 'E-mail',
    topClientsTurnover: 'Оборот',
    available: 'Доступно к выплате',
    cashbackSteam: 'Кэшбек STEAM',
    cashbackTopup: 'Кэшбек TOPUP',
  ...
  directorTransactions: {
    heading: 'Транзакции',
    topupTitle: 'История пополнений',
    purchaseTitle: 'История покупок',
    refreshTitle: 'Обновить',
    loading: 'Загрузка...',
    loadError: 'Ошибка загрузки данных',
    empty: 'Нет данных',
    ...
    amount: 'Сумма',
    topup: {
      balanceBefore: 'Баланс до пополнения',
  ...
  directorReports: {
    heading: 'Выплаты',
    payoutTitle: 'История выплат',
    accrualTitle: 'История начислений',
    refreshTitle: 'Обновить',
    loading: 'Загрузка...',
    loadError: 'Ошибка загрузки данных',
    empty: 'Нет данных',
    ...
    transactionId: 'ID Транзакции',
    method: 'Способ',
    refOrderId: 'ID заказа',
    refOrderType: 'Тип заказа',
