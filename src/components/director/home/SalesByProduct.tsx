...
function SalesByProduct({ period = "all" }: SalesByProductProps) {
    ...
    return (
        <div className="p-6.5 border border-[#00000026] rounded-[16px] flex flex-col justify-between gap-4">
            ...
            {isLoading ? (
                ...
                <>
                    ...
                    />
                    <div className="relative w-full max-w-[218px] m-auto aspect-square">
