        ...
        <div className="mt-5 px-5 py-[32px] border border-[#00000026] rounded-[16px]">
            ...
            <div className="flex items-end gap-4">
                ...
                <div className="w-[240px] flex items-center gap-2 text-[14px] font-medium border border-[#00000026] rounded-[8px] px-4 py-[8.5px] outline-0 appearance-none cursor-pointer">
                    ...
                    <input type="text" placeholder="Введите ID транзакции" className="w-full outline-0 text-[14px] font-medium" />
                </div>
                <button className="bg-[#2D85EA] text-white text-[15px] font-medium rounded-[8px] px-3 py-[8.75px] w-[120px] cursor-pointer">Поиск</button>
                <button className="text-[15px] font-medium text-[#2D85EA] h-[40px] cursor-pointer">Сбросить</button>
            </div>
        </div>
    )
}
