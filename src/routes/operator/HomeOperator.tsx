    ...
    return (
        <div className="px-20 max-1lg:px-15 max-md:px-8 max-sm:px-4 pb-[100px] mt-[28px]">
            <div className='max-w-[1680px] m-auto'>
                <div className="flex justify-between mb-6 gap-10.5 max-1lg:flex-col">
                    <div>
                        <h1 className="text-[26px] font-bold">{t.homeOperator.mainSections}</h1>

                        <div className='mt-4 flex gap-4 max-2lg:gap-6 max-1md:grid max-1md:grid-cols-2'>
                            <Link to="/operator/product?group=Steam">
                                <div className="overflow-hidden rounded-[24px] max-w-[200px] max-2lg:max-w-[180px] max-1md:max-w-full">
                                    <img src="/home/1.png" alt="home" className='w-full transition-transform duration-200 hover:scale-105' />
                                </div>
                            ...
                            <Link to="/operator/esim">
                                <div className="overflow-hidden rounded-[24px] max-w-[200px] max-2lg:max-w-[180px] max-1md:max-w-full">
                                    <img src="/home/4.png" alt="home" className='w-full transition-transform duration-200 hover:scale-105' />
                                </div>
                                <b className='pt-3 flex justify-center'>{t.homeOperator.esim}</b>
                            </Link>
                        </div>
                    </div>
                    <div className='w-[566px] max-2lg:w-[420px] max-1lg:w-full h-[260px] p-8 border border-[#00000026] rounded-[16px]'>
                ...
                <div className='mt-7 mb-6 border w-[552px] border-[#00000026] p-8 text-[24px] rounded-[24px] max-md:w-full max-md:p-6 max-md:text-[20px]'>
